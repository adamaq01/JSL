...
import org.jsl.*;
import org.jsl.glsl.fragments.StructFragment;
import org.joml.*;
...
public class GLSLEncoder extends CodeEncoder {
    ...
    private void handleMethodCallFragment(MethodCallFragment fragment, List<CodeFragment> in, int index, StringBuilder out) throws ClassNotFoundException {
        ...
        if (fragment.invokeType == MethodCallFragment.InvokeTypes.SPECIAL && currentMethod.name.equals("<init>") && fragment.methodOwner.equals(currentClass.superclass)) {
